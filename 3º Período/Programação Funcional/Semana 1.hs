...
3.6
-}
precoComDesconto preco quantidade limite desconto = if quantidade <= limite then preco * quantidade
                                                    else if desconto < 0 || desconto > 1 then preco * quantidade 
                                                    else (preco * quantidade) - (preco * quantidade * desconto)
...
-}
{-
Vou assumir que m1 e m2 nunca tem o mesmo valor
-}
pedraTesouraPapel m1 m2 = if (m1 == 0 && m2 == 1) then True

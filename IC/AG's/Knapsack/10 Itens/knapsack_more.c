...
void preenche_mochila(item mochila[])
{
    ...
    mochila[3].valor = 40;
    mochila[3].peso = 333;
    strcpy(mochila[4].nome, "Water Bottle");
    mochila[4].valor = 30;
    mochila[4].peso = 192;
    strcpy(mochila[5].nome, "Phone");
    mochila[5].valor = 500;
    mochila[5].peso = 200;
    strcpy(mochila[6].nome, "Mints");
    mochila[6].valor = 5;
    mochila[6].peso = 25;
    strcpy(mochila[7].nome, "Socks");
    mochila[7].valor = 10;
    mochila[7].peso = 38;
    strcpy(mochila[8].nome, "Tissues");
    mochila[8].valor = 15;
    mochila[8].peso = 80;
    strcpy(mochila[9].nome, "Baseball Cap");
    mochila[9].valor = 100;
    mochila[9].peso = 70;
}
